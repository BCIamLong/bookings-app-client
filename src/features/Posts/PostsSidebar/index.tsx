...
export default function PostsSidebar() {
  return (
    <div className="h-screen">
      <ul className="[&>li>.active]:text-brand-600 [&>li>.active]:bg-stone-50 bg-stone-0 flex flex-col gap-3 h-full border-r-2 border-stone-50 shadow-sm overflow-hidden">
        <li >
          <NavLink to=''>
